...
8. **Binary_matrix.csv** (optional): upload your own binary matrix if needed,e.g., if you are using a different binarisation scheme. The same format as Count_matrix.csv.
## Libarary:
